...
```bash
hyprland waybar-hyprland-git cava waybar-mpris-git python rustup kitty zsh wofi xdg-desktop-portal-hyprland tty-clock-git swaylockd grim slurp btop pfetch-rs jq dunst wl-clipboard swaylock-effects-git swww swayidle wlogout neovim
```
